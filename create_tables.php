...
echo "Creating SIMBA database tables...\n";
...
try {
    ...
    echo "Table 'sequences' created or already exists.\n";
    
    // Create kategoribarang table
    $pdo->exec("CREATE TABLE IF NOT EXISTS kategoribarang (
        idkategori INT PRIMARY KEY,
        nama_kategori VARCHAR(100) NOT NULL,
        keterangan TEXT NULL
    )");
    echo "Table 'kategoribarang' created or already exists.\n";
    
    // Insert kategoribarang data if not exists
    $stmt = $pdo->prepare("INSERT IGNORE INTO kategoribarang (idkategori, nama_kategori, keterangan) VALUES (?, ?, ?)");
    $categories = [
    ...
    // Insert users data if not exists
    $stmt = $pdo->prepare("INSERT IGNORE INTO users (iduser, username, nama, password, email, roletype) VALUES (?, ?, ?, ?, ?, ?)");
    $users = [
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS m_barang (
    ...
    echo "Table 'm_barang' created or already exists.\n";
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS purchaserequest (
    ...
    echo "Table 'purchaserequest' created or already exists.\n";
    
    // Create detailrequest table
    $pdo->exec("CREATE TABLE IF NOT EXISTS detailrequest (
    ...
    echo "Table 'detailrequest' created or already exists.\n";
    
    // Create purchaseorder table
    $pdo->exec("CREATE TABLE IF NOT EXISTS purchaseorder (
    ...
    echo "Table 'purchaseorder' created or already exists.\n";
    
    // Create detailorder table
    $pdo->exec("CREATE TABLE IF NOT EXISTS detailorder (
    ...
    echo "Table 'detailorder' created or already exists.\n";
    
    // Create barangmasuk table
    $pdo->exec("CREATE TABLE IF NOT EXISTS barangmasuk (
    ...
    echo "Table 'barangmasuk' created or already exists.\n";
    
    // Create detailmasuk table
    $pdo->exec("CREATE TABLE IF NOT EXISTS detailmasuk (
    ...
    echo "Table 'detailmasuk' created or already exists.\n";
    
    // Create barangkeluar table
    $pdo->exec("CREATE TABLE IF NOT EXISTS barangkeluar (
    ...
    echo "Table 'barangkeluar' created or already exists.\n";
    
    // Create detailkeluar table
    $pdo->exec("CREATE TABLE IF NOT EXISTS detailkeluar (
    ...
    echo "Table 'detailkeluar' created or already exists.\n";
    
    // Create logstatusreq table
    $pdo->exec("CREATE TABLE IF NOT EXISTS logstatusreq (
    ...
    echo "Table 'logstatusreq' created or already exists.\n";
    
    // Create logstatusorder table
    $pdo->exec("CREATE TABLE IF NOT EXISTS logstatusorder (
    ...
    echo "Table 'logstatusorder' created or already exists.\n";
    
    // Create logstatusbarang table
    $pdo->exec("CREATE TABLE IF NOT EXISTS logstatusbarang (
    ...
    echo "Table 'logstatusbarang' created or already exists.\n";
    
    // Initialize sequences if not exists
    $pdo->exec("INSERT IGNORE INTO sequences (name, last_no) VALUES
        ('m_barang', 0),
        ('purchaserequest', 0),
        ('purchaseorder', 0),
        ('barangmasuk', 0),
